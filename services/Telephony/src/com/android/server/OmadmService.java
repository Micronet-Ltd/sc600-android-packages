...
public class OmadmService extends IOmadmManager.Stub {
    ...
    public BroadcastReceiver mEvHandlerReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.w(TAG, "BroadcastReceiver::onReceive() action: "+intent.getAction());
    ...
    * @endparblock
    ...
    public int installUpdateImage(String path)  {
        ...
        Intent updateIntent =new Intent("com.verizon.dmclientupdate.Fumo.UPDATE_FOTA") ;
        updateIntent.putExtra("update_path",path);
